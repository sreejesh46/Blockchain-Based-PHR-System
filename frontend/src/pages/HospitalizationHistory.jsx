...
const HospitalizationHistory = () => {
    ...
    const renderHospHistory = () => {
        if (loading) {
            return <tr><td colSpan="5">Loading...</td></tr>;
        } else if (hospHistory.length === 0) {
            return <tr><td colSpan="5">No Hospitalization History found</td></tr>;
        } else {
            return hospHistory.map((item, index) => (
                <tr key={index}>
                    <td>{item.datefrom}</td>
                    <td>{item.dateto}</td>
                    <td>{item.reason}</td>
    ...
    return (
        <div className="flex relative dark:bg-main-dark-bg">
            ...
            <div
                className={"dark:bg-main-dark-bg  bg-main-bg min-h-screen ml-72 w-full  "}
            >
